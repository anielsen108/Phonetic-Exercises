# Coarticulation Study: /dʒ/ + /m/

### Sequence: voiced postalveolar affricate → bilabial nasal

### Example Phrase: **judge me**

**IPA:** `/dʒʌdʒ mi/`
**Allophonic detail:** `[dʒʌdʒ mi[`
...
2. **Voicing Continuity:**
   Both /dʒ/ and /m/ are voiced; the glottis remains adducted throughout. Spectrographically, this appears as a continuous low-frequency voicing bar.
...
2. Say **"me"** starting with an isolated /m/.
3. Merge: *judge me* — maintain voicing continuity, minimize release between segments.
4. Record and compare:

   * Over-released: Excessive separation between sounds
   * Balanced: Natural liaison as transcribed `/dʒʌdʒ mi/`
   * Under-articulated: Loss of primary articulatory cues

### 4.2 Gestural Continuity Exercise

* Focus awareness on active articulators for both /dʒ/ and /m/.
* Alternate "dʒ-m-dʒ-m" while maintaining voicing where applicable.
...
| ------------------------------ | ------------------------------------- | ------------------- |
| **Place shift                 ** | postalveolar → bilabial               | /dʒ m/, similar front-back transitions |
| **Voicing pattern             ** | voiced to voiced                      | Common in /dʒ m/ sequences |
| **Manner transition           ** | affricate → nasal                     | Affects timing and release |


Understanding this combination helps refine articulation for all cross-place sequences involving affricate and nasal manners.

---

## 6. Summary Points

* /dʒ/ + /m/ is a **voiced, cross-place sequence** showing distinctive coarticulatory patterns.
...
| Phrase | IPA | Note |
| ---------- | ----------------- | -------------------------------------- |
| judge me   | `/dʒʌdʒ mi/     ` | Affricate → bilabial nasal             |

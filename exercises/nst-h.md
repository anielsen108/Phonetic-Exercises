# Coarticulation Study: /nst/ + /h/

### Sequence: nasal + fricative + stop cluster → voiceless glottal fricative

### Example Phrase: **against hate**

**IPA:** `/əˈɡɛnst̚ heɪt/`
**Allophonic detail:** `[əˈɡɛnst̚ heɪt[`
...
* **/nst/**: Stop release followed by breathy glottal onset
...
1. **Anticipatory Place Shift:**
   The tongue/lips begin moving toward the glottal target before the /nst/ gesture completes. This creates overlap between nasal-alveolar-alveolar and glottal articulations.
...
3. **Stop Release Modification:**
   The /nst/ closure releases directly into the /h/ articulation, often showing reduced or absent burst energy.
...
2. Say **"hate"** starting with an isolated /h/.
3. Merge: *against hate* — maintain voicing continuity, minimize release between segments.
4. Record and compare:

   * Over-released: Excessive separation between sounds
   * Balanced: Natural liaison as transcribed `/əˈɡɛnst̚ heɪt/`
   * Under-articulated: Loss of primary articulatory cues

### 4.2 Gestural Continuity Exercise

* Focus awareness on active articulators for both /nst/ and /h/.
* Alternate "nst-h-nst-h" while maintaining voicing where applicable.
...
| ------------------------------ | ------------------------------------- | ------------------- |
| **Place shift                 ** | nasal-alveolar-alveolar → glottal     | /nst h/, similar front-back transitions |
| **Voicing pattern             ** | voiced then voiceless to voiceless    | Common in /nst h/ sequences |
...
* /nst/ + /h/ is a **mixed-voicing, cross-place sequence** showing distinctive coarticulatory patterns.
...
| Phrase | IPA | Note |
| ---------- | ----------------- | -------------------------------------- |
| against hate | `/əˈɡɛnst̚ heɪt/` | Stop release followed by breathy glottal onset |
| against history | `/əˈɡɛnst̚ ˈhɪstəɹi/` | Glottal fricative after stop closure   |

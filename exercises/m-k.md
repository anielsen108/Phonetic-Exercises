# Coarticulation Study: /m/ + /k/

### Sequence: bilabial nasal → voiceless velar stop

### Example Phrase: **time came**

**IPA:** `/tʰaɪm kʰeɪm/`
**Allophonic detail:** `[tʰaɪm kʰeɪm[`
...
|----------|---------|--------|----------|-----------|-----------|-----------|
| First | /m/ | bilabial | nasal | voiced | nasal | continuous resonant |
...
1. **Anticipatory Place Shift:**
   The tongue/lips begin moving toward the velar target before the /m/ gesture completes. This creates overlap between bilabial and velar articulations.
...
1. Say **"time"** slowly, establishing full /m/ articulation.
2. Say **"came"** starting with an isolated /k/.
3. Merge: *time came* — maintain voicing continuity, minimize release between segments.
4. Record and compare:

   * Over-released: Excessive separation between sounds
   * Balanced: Natural liaison as transcribed `/tʰaɪm kʰeɪm/`
   * Under-articulated: Loss of primary articulatory cues

### 4.2 Gestural Continuity Exercise

* Focus awareness on active articulators for both /m/ and /k/.
* Alternate "m-k-m-k" while maintaining voicing where applicable.
...
| ------------------------------ | ------------------------------------- | ------------------- |
| **Place shift                 ** | bilabial → velar                      | /m k/, similar front-back transitions |
| **Voicing pattern             ** | voiced to voiceless                   | Common in /m k/ sequences |
| **Manner transition           ** | nasal → stop                          | Affects timing and release |


Understanding this combination helps refine articulation for all cross-place sequences involving nasal and stop (plosive) manners.

---

## 6. Summary Points

* /m/ + /k/ is a **mixed-voicing, cross-place sequence** showing distinctive coarticulatory patterns.
...
| Phrase | IPA | Note |
| ---------- | ----------------- | -------------------------------------- |
| time came  | `/tʰaɪm kʰeɪm/  ` | Bilabial → velar                       |

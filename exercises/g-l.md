# Coarticulation Study: /g/ + /l/

### Sequence: voiced velar stop → alveolar lateral approximant

### Example Phrase: **juggle**

**IPA:** `/ˈd͡ʒʌɡɫ̩/`
**Allophonic detail:** `[ˈd͡ʒʌɡɫ̩[`
...
|----------|---------|--------|----------|-----------|-----------|-----------|
| First | /g/ | velar | stop (plosive) | voiced | oral | short, often reduced finally |
...
1. **Anticipatory Place Shift:**
   The tongue/lips begin moving toward the alveolar target before the /g/ gesture completes. This creates overlap between velar and alveolar articulations.

2. **Voicing Continuity:**
   Both /g/ and /l/ are voiced; the glottis remains adducted throughout. Spectrographically, this appears as a continuous low-frequency voicing bar.

3. **Stop Release Modification:**
   The /g/ closure releases directly into the /l/ articulation, often showing reduced or absent burst energy.
...
1. Say **"juggle"** slowly, establishing full /g/ articulation.
2. Say **"l"** starting with an isolated /l/.
3. Merge: *juggle* — maintain voicing continuity, minimize release between segments.
4. Record and compare:

   * Over-released: Excessive separation between sounds
   * Balanced: Natural liaison as transcribed `/ˈd͡ʒʌɡɫ̩/`
   * Under-articulated: Loss of primary articulatory cues

### 4.2 Gestural Continuity Exercise

* Focus awareness on active articulators for both /g/ and /l/.
* Alternate "g-l-g-l" while maintaining voicing where applicable.
...
| ------------------------------ | ------------------------------------- | ------------------- |
| **Place shift                 ** | velar → alveolar                      | /g l/, similar front-back transitions |
| **Voicing pattern             ** | voiced to voiced                      | Common in /g l/ sequences |
...
* /g/ + /l/ is a **voiced, cross-place sequence** showing distinctive coarticulatory patterns.
...
| Phrase | IPA | Note |
| ---------- | ----------------- | -------------------------------------- |
| juggle     | `/ˈd͡ʒʌɡɫ̩/     ` | Lateral release                        |

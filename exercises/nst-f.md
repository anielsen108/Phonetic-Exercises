# Coarticulation Study: /nst/ + /f/

### Sequence: nasal + fricative + stop cluster → voiceless labiodental fricative

### Example Phrase: **against family**

**IPA:** `/əˈɡɛnst̚ ˈfæməli/`
**Allophonic detail:** `[əˈɡɛnst̚ ˈfæməli[`
...
* **/nst/**: Stop to fricative: oral release into labiodental constriction
...
3. **Stop Release Modification:**
   The /nst/ closure releases directly into the /f/ articulation, often showing reduced or absent burst energy.
...
2. Say **"family"** starting with an isolated /f/.
3. Merge: *against family* — maintain voicing continuity, minimize release between segments.
4. Record and compare:

   * Over-released: Excessive separation between sounds
   * Balanced: Natural liaison as transcribed `/əˈɡɛnst̚ ˈfæməli/`
   * Under-articulated: Loss of primary articulatory cues

### 4.2 Gestural Continuity Exercise

* Focus awareness on active articulators for both /nst/ and /f/.
* Alternate "nst-f-nst-f" while maintaining voicing where applicable.
...
| ------------------------------ | ------------------------------------- | ------------------- |
| **Place shift                 ** | nasal-alveolar-alveolar → labiodental | /nst f/, similar front-back transitions |
| **Voicing pattern             ** | voiced then voiceless to voiceless    | Common in /nst f/ sequences |
...
* /nst/ + /f/ is a **mixed-voicing, cross-place sequence** showing distinctive coarticulatory patterns.
...
| Phrase | IPA | Note |
| ---------- | ----------------- | -------------------------------------- |
| against family | `/əˈɡɛnst̚ ˈfæməli/` | Stop to fricative: oral release into labiodental c... |
| against forces | `/əˈɡɛnst̚ ˈfoɹsɪz/` | Complete oral closure → partial (fricative) constr... |

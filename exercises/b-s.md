# Coarticulation Study: /b/ + /s/

### Sequence: voiced bilabial stop → voiceless alveolar fricative

### Example Phrase: **cabs**

**IPA:** `/kʰæbz/`
**Allophonic detail:** `[kʰæbz[`
...
3. **Stop Release Modification:**
   The /b/ closure releases directly into the /s/ articulation, often showing reduced or absent burst energy.
...
1. Say **"cabs"** slowly, establishing full /b/ articulation.
2. Say **"s"** starting with an isolated /s/.
3. Merge: *cabs* — maintain voicing continuity, minimize release between segments.
4. Record and compare:

   * Over-released: Excessive separation between sounds
   * Balanced: Natural liaison as transcribed `/kʰæbz/`
   * Under-articulated: Loss of primary articulatory cues

### 4.2 Gestural Continuity Exercise

* Focus awareness on active articulators for both /b/ and /s/.
* Alternate "b-s-b-s" while maintaining voicing where applicable.
...
| ------------------------------ | ------------------------------------- | ------------------- |
| **Place shift                 ** | bilabial → alveolar                   | /b s/, similar front-back transitions |
| **Voicing pattern             ** | voiced to voiceless                   | Common in /b s/ sequences |
...
* /b/ + /s/ is a **mixed-voicing, cross-place sequence** showing distinctive coarticulatory patterns.

# Coarticulation Study: /dʒ/ + /p/

### Sequence: voiced postalveolar affricate → voiceless bilabial stop

### Example Phrase: **large piece**

**IPA:** `/lɑɹdʒ pʰis/`
**Allophonic detail:** `[lɑɹdʒ pʰis[`
...
1. **Anticipatory Place Shift:**
   The tongue/lips begin moving toward the bilabial target before the /dʒ/ gesture completes. This creates overlap between postalveolar and bilabial articulations.
...
2. Say **"piece"** starting with an isolated /p/.
3. Merge: *large piece* — maintain voicing continuity, minimize release between segments.
4. Record and compare:

   * Over-released: Excessive separation between sounds
   * Balanced: Natural liaison as transcribed `/lɑɹdʒ pʰis/`
   * Under-articulated: Loss of primary articulatory cues

### 4.2 Gestural Continuity Exercise

* Focus awareness on active articulators for both /dʒ/ and /p/.
* Alternate "dʒ-p-dʒ-p" while maintaining voicing where applicable.
...
| ------------------------------ | ------------------------------------- | ------------------- |
| **Place shift                 ** | postalveolar → bilabial               | /dʒ p/, similar front-back transitions |
| **Voicing pattern             ** | voiced to voiceless                   | Common in /dʒ p/ sequences |
...
* /dʒ/ + /p/ is a **mixed-voicing, cross-place sequence** showing distinctive coarticulatory patterns.
...
| Phrase | IPA | Note |
| ---------- | ----------------- | -------------------------------------- |
| large piece | `/lɑɹdʒ pʰis/   ` | Affricate → voiceless stop             |

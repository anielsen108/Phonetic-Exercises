# Coarticulation Study: /p/ + /l/

### Sequence: voiceless bilabial stop → alveolar lateral approximant

### Example Phrase: **apple**

**IPA:** `/ˈæpɫ̩/`
**Allophonic detail:** `[ˈæpɫ̩[`
...
3. **Stop Release Modification:**
   The /p/ closure releases directly into the /l/ articulation, often showing reduced or absent burst energy.
...
1. Say **"apple"** slowly, establishing full /p/ articulation.
2. Say **"l"** starting with an isolated /l/.
3. Merge: *apple* — maintain voicing continuity, minimize release between segments.
4. Record and compare:

   * Over-released: Excessive separation between sounds
   * Balanced: Natural liaison as transcribed `/ˈæpɫ̩/`
   * Under-articulated: Loss of primary articulatory cues

### 4.2 Gestural Continuity Exercise

* Focus awareness on active articulators for both /p/ and /l/.
* Alternate "p-l-p-l" while maintaining voicing where applicable.
...
| ------------------------------ | ------------------------------------- | ------------------- |
| **Place shift                 ** | bilabial → alveolar                   | /p l/, similar front-back transitions |
| **Voicing pattern             ** | voiceless to voiced                   | Common in /p l/ sequences |
...
* /p/ + /l/ is a **mixed-voicing, cross-place sequence** showing distinctive coarticulatory patterns.
...
| Phrase | IPA | Note |
| ---------- | ----------------- | -------------------------------------- |
| apple      | `/ˈæpɫ̩/        ` | Lateral release, dark /ɫ̩/             |

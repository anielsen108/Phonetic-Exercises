# Coarticulation Study: /l/ + /m/

### Sequence: alveolar lateral approximant → bilabial nasal

### Example Phrase: **film**

**IPA:** `/fɪɫm/`
**Allophonic detail:** `[fɪɫm[`
...
* **/l/**: Lateral before bilabial nasal
...
2. **Voicing Continuity:**
   Both /l/ and /m/ are voiced; the glottis remains adducted throughout. Spectrographically, this appears as a continuous low-frequency voicing bar.
...
1. Say **"film"** slowly, establishing full /l/ articulation.
2. Say **"m"** starting with an isolated /m/.
3. Merge: *film* — maintain voicing continuity, minimize release between segments.
4. Record and compare:

   * Over-released: Excessive separation between sounds
   * Balanced: Natural liaison as transcribed `/fɪɫm/`
   * Under-articulated: Loss of primary articulatory cues

### 4.2 Gestural Continuity Exercise

* Focus awareness on active articulators for both /l/ and /m/.
* Alternate "l-m-l-m" while maintaining voicing where applicable.
...
| ------------------------------ | ------------------------------------- | ------------------- |
| **Place shift                 ** | alveolar → bilabial                   | /l m/, similar front-back transitions |
| **Voicing pattern             ** | voiced to voiced                      | Common in /l m/ sequences |
| **Manner transition           ** | lateral → nasal                       | Affects timing and release |


Understanding this combination helps refine articulation for all cross-place sequences involving lateral approximant and nasal manners.

---

## 6. Summary Points

* /l/ + /m/ is a **voiced, cross-place sequence** showing distinctive coarticulatory patterns.
...
| Phrase | IPA | Note |
| ---------- | ----------------- | -------------------------------------- |
| film       | `/fɪɫm/         ` | Lateral before bilabial nasal          |

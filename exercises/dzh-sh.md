# Coarticulation Study: /dʒ/ + /ʃ/

### Sequence: voiced postalveolar affricate → voiceless postalveolar fricative

### Example Phrase: **large ship**

**IPA:** `/lɑɹdʒ ʃɪp/`
**Allophonic detail:** `[lɑɹdʒ ʃɪp[`
...
* **/dʒ/**: Voiced → voiceless postalveolar
...
2. Say **"ship"** starting with an isolated /ʃ/.
3. Merge: *large ship* — maintain voicing continuity, minimize release between segments.
4. Record and compare:

   * Over-released: Excessive separation between sounds
   * Balanced: Natural liaison as transcribed `/lɑɹdʒ ʃɪp/`
   * Under-articulated: Loss of primary articulatory cues

### 4.2 Gestural Continuity Exercise

* Focus awareness on active articulators for both /dʒ/ and /ʃ/.
* Alternate "dʒ-ʃ-dʒ-ʃ" while maintaining voicing where applicable.
...
| ------------------------------ | ------------------------------------- | ------------------- |
| **Place shift                 ** | postalveolar → postalveolar           | /dʒ ʃ/, similar front-back transitions |
| **Voicing pattern             ** | voiced to voiceless                   | Common in /dʒ ʃ/ sequences |
...
* /dʒ/ + /ʃ/ is a **mixed-voicing, homorganic sequence** showing distinctive coarticulatory patterns.
...
| Phrase | IPA | Note |
| ---------- | ----------------- | -------------------------------------- |
| large ship | `/lɑɹdʒ ʃɪp/    ` | Voiced → voiceless postalveolar        |

# Coarticulation Study: /w/ + /p/

### Sequence: labial-velar approximant → voiceless bilabial stop

### Example Phrase: **now pay**

**IPA:** `/naʊ pʰeɪ/`
**Allophonic detail:** `[naʊ pʰeɪ[`
...
3. Merge: *now pay* — maintain voicing continuity, minimize release between segments.
4. Record and compare:

   * Over-released: Excessive separation between sounds
   * Balanced: Natural liaison as transcribed `/naʊ pʰeɪ/`
   * Under-articulated: Loss of primary articulatory cues

### 4.2 Gestural Continuity Exercise

* Focus awareness on active articulators for both /w/ and /p/.
* Alternate "w-p-w-p" while maintaining voicing where applicable.
...
| ------------------------------ | ------------------------------------- | ------------------- |
| **Place shift                 ** | labial-velar → bilabial               | /w p/, similar front-back transitions |
| **Voicing pattern             ** | voiced to voiceless                   | Common in /w p/ sequences |
...
* /w/ + /p/ is a **mixed-voicing, cross-place sequence** showing distinctive coarticulatory patterns.
...
| Phrase | IPA | Note |
| ---------- | ----------------- | -------------------------------------- |
| now pay    | `/naʊ pʰeɪ/     ` | Labiovelar → bilabial                  |

# Coarticulation Study: /nst/ + /s/

### Sequence: nasal + fricative + stop cluster → voiceless alveolar fricative

### Example Phrase: **against science**

**IPA:** `/əˈɡɛnst̚ ˈsaɪəns/`
**Allophonic detail:** `[əˈɡɛnst̚ ˈsaɪəns[`
...
3. **Stop Release Modification:**
   The /nst/ closure releases directly into the /s/ articulation, often showing reduced or absent burst energy.
...
2. Say **"science"** starting with an isolated /s/.
3. Merge: *against science* — maintain voicing continuity, minimize release between segments.
4. Record and compare:

   * Over-released: Excessive separation between sounds
   * Balanced: Natural liaison as transcribed `/əˈɡɛnst̚ ˈsaɪəns/`
   * Under-articulated: Loss of primary articulatory cues

### 4.2 Gestural Continuity Exercise

* Focus awareness on active articulators for both /nst/ and /s/.
* Alternate "nst-s-nst-s" while maintaining voicing where applicable.
...
| ------------------------------ | ------------------------------------- | ------------------- |
| **Place shift                 ** | nasal-alveolar-alveolar → alveolar    | /nst s/, similar front-back transitions |
| **Voicing pattern             ** | voiced then voiceless to voiceless    | Common in /nst s/ sequences |
| **Manner transition           ** | nasal → fricative                     | Affects timing and release |


Understanding this combination helps refine articulation for all cross-place sequences involving nasal + fricative + stop and fricative (sibilant) manners.

---

## 6. Summary Points

* /nst/ + /s/ is a **mixed-voicing, cross-place sequence** showing distinctive coarticulatory patterns.
...
| Phrase | IPA | Note |
| ---------- | ----------------- | -------------------------------------- |
| against science | `/əˈɡɛnst̚ ˈsaɪəns/` | Homorganic: both alveolar; /t/ often deleted befor... |
| against society | `/əˈɡɛnst̚ səˈsaɪəti/` | Alveolar sequence: /ts/ may reduce to [s] |
